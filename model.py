...
class CaptchaBreaker(tf.keras.Model):
    def __init__(self):
        ...
        self.backbone_layers.append( layers.Conv2D(32, (3,3), activation='relu') )
        self.backbone_layers.append( layers.BatchNormalization() )
        self.backbone_layers.append( layers.Conv2D(64, (3,3), activation='relu') )
        self.backbone_layers.append( layers.BatchNormalization() )
        self.backbone_layers.append( layers.MaxPool2D((2,2)) )
        self.backbone_layers.append( layers.Conv2D(64, (3,3), activation='relu') )
        self.backbone_layers.append( layers.BatchNormalization() )
        self.backbone_layers.append( layers.Conv2D(128, (3,3), activation='relu') )
        self.backbone_layers.append( layers.BatchNormalization() )
        self.backbone_layers.append( layers.MaxPool2D((2,2)) )
        self.backbone_layers.append( layers.Conv2D(128, (3,3), activation='relu') )
        self.backbone_layers.append( layers.BatchNormalization() )
